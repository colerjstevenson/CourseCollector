...
def load_multiple_csvs(csv_paths):
    ...
    for path in csv_paths:
        ...
        # Standardize name column - handle both 'name' and 'CourseName'
        if 'name' in df.columns and 'CourseName' not in df.columns:
            df['CourseName'] = df['name']
        elif 'CourseName' not in df.columns and 'name' not in df.columns:
            df['CourseName'] = 'Unknown Golf Course'
